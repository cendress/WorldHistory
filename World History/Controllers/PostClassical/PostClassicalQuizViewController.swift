...
class PostClassicalQuizViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    loadNextQuestion()
    addPostClassicalQuizStartOverlay()
  }
  ...
  func loadNextQuestion() {
    ...
    scoreLabel.text = "Question \(questionNumber)/\(postClassicalQuizBrain.questions.count)"
...
extension UIViewController {
  func addPostClassicalQuizStartOverlay() {
  ...
  @objc func removePostClassicalQuizStartOverlay() {
