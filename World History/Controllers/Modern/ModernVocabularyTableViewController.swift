...
class ModernVocabularyTableViewController: UITableViewController {
  ...
  let modernVocabularyTerms: [VocabularyTerm] = [
    ...
    .init(term: "Freudianism", definition: "Freudian psychology is based on the work of Sigmund Freud, who developed the theory of psychoanalysis. It focuses on the influence of the unconscious mind on behavior."),
