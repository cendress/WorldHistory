...
class ContemporaryVocabularyTableViewController: UITableViewController {
  ...
  let contemporaryVocabularyTerms: [VocabularyTerm] = [
    ...
    .init(term: "Civil Rights Movement", definition: "A struggle for social justice that took place mainly during the 1950s and 1960s for blacks to gain equal rights under the law in the United States."),
    .init(term: "Global Financial Crisis", definition: "A severe worldwide economic crisis that occurred in the early 21st century. It was the most serious financial crisis since the Great Depression."),
